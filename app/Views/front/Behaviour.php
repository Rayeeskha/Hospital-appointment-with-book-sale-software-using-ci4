          ...
          <div class="col-sm-10 col-md-12 col-lg-12">
            <div class="campaign bg-silver-light maxwidth500 mb-30">
              ...
              <div class="campaign-details clearfix p-15 pt-10 pb-10">
                ...
                <h4 class="font-weight-700 mt-0"><a href="javascript:void(0)"><?= lang("home.BehaviourManagement"); ?></a></h4>
            ...
            <div class="event-details">
              <p class="mb-20 mt-20"><?= lang("home.Bhtitle1"); ?></p>
              <div class="pull-left flip mr-15">
                <img alt="" src="<?= base_url("public/assets/images/ab/sr8.png"); ?>">
              </div>
              <div class="">
                <p class="font-14 text-black-light"><?= lang("home.Bhtitle2"); ?></p>
                <p class="mt-10"><?= lang("home.Bhtitle3"); ?></p>
              </div>
              <p class="mt-20"><?= lang("home.Bhtitle4"); ?>
              </p>
            </div>
          </div>
