	...
	<div class="col-xl-12 mx-auto">
		...
		<div class="card border-top border-0 border-4 border-primary">
			<div class="card-body p-5">
				...
				<hr>
				<form class="row g-3" action="<?= base_url('Admin/updatedeprt/'.$editcate[0]->id); ?>" method="post" enctype="multipart/form-data">
					<div class="col-md-6">
						<label for="inputFirstName" class="form-label">Department Name</label>
						<input type="text" class="form-control" id="inputFirstName" name="departmentname" value="<?= $editcate[0]->departmentname; ?>">
