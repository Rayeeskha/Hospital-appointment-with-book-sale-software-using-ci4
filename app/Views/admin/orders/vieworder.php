			...
			<div class="invoice overflow-auto">
				<div style="min-width: 600px">
					...
					<main>
						...
						<div class="col-md-6">
						<?= form_open('Admin/changeorder/'.$orders[0]->order_id); ?>
						<label>Change Order Status</label>
						<select name="orderstatus" class="form-control">
						    <option value="<?= $orders[0]->order_status; ?>"selected><?= $orders[0]->order_status; ?></option>
						...
						<a href="<?= base_url('Admin/orderinvoice/'.$orders[0]->order_id); ?>" class="btn btn-warning" target="_blank">Invoice</a>
						<?= form_close(); ?>
					</div>	
					</main>
